...
public class LastNLinesModalView extends BaseElement
{
    @FindBy(xpath = "//div[@class = 'logs-modal-content']")
    ...
    {
        WebElement viewButton = content.findElement(By.cssSelector(id + " .btn-primary"));
        viewButton.click();
