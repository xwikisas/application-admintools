...
class ConfigurationJavaHealthCheckTest
{
    ...
    static void setUp() throws Exception
    {
        ...
        when(localization.getTranslationPlain("adminTools.dashboard.healthcheck.java.info")).thenReturn(
            "Java status OK");
        when(localization.getTranslationPlain("adminTools.dashboard.healthcheck.java.warn.found")).thenReturn(
            "Java version not found!");
        when(localization.getTranslationPlain("adminTools.dashboard.healthcheck.java.warn.incompatible")).thenReturn(
            "Java version is not compatible with the current XWiki installation!");
    }
