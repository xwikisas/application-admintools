...
/**
 * Render a given template and bind data to it.
 *
 * @version $Id$
 * @since 1.0
 */
@Component(roles = DefaultTemplateRender.class)
@Singleton
public class DefaultTemplateRender
{
    @Inject
    ...
    /**
     * Get the data rendered in a format provided by the template.
     *
     ...
     * @return a {@link String} with the data formatted by the associated template.
     */
    public String getRenderedTemplate(String template, Map<String, String> data, String hint)
    {
        try {
