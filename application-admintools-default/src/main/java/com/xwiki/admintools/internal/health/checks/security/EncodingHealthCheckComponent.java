...
@Component
@Named(EncodingHealthCheckComponent.HINT)
@Singleton
public class EncodingHealthCheckComponent implements HealthCheckComponent
{
    public static final String HINT = "ENCODING_HEALTH";
